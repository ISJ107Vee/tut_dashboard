...
# function to close browser on logout 
def close_program():
    
    # closing the web browser on logout
    os.system("taskkill /im firefox.exe /f")
    os.system("taskkill /im chrome.exe /f") 
    os.system("taskkill /im brave.exe /f")

    #re-opening login web page 
...
if selected == "Home":
    ...
    # removing the option to select another option after logout 

    # displaying a blank screen with no options or dashboard display
    st.markdown("""
    <style>
