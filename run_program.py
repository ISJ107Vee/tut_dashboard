# importing external functions and python libraries 
import numpy as np
import pandas as pd
...
# function to display data by faculty selection on the dashboard
def faculty():
...
# setting up the page header components
...
if selected == "Home":
    ...
    # implementing a logout work around due to streamlit limitation
    if st.button("Click To Sign Out"):
        st.markdown("""
            <meta http-equiv="refresh" content="0; url='https://isj107vee.github.io/login/'" />
